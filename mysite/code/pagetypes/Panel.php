...
class Panel extends Page {
	...
	private static $icon = 'mysite/icons/panel.png';
	...
	public function getCMSFields()
	{
		...
		$uploadField->setFolderName('PanelHeroImages');
    ...
    {	
        ...
        //$this->SortOrder = '2010-01-01 01:00:00';
...
class Panel_Controller extends Page_Controller {
    ...
    public function promoteContentID()
    {
        ...
        if($promoteID == NULL){
            ...
            $promoteID = $AssociatedPages->sort(array($Sort=>$Order))->first()->ID;
