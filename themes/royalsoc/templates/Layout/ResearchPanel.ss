...
<div class="container">
    ...
    <% if $ClassName == 'ResearchPanel' %>
        <div class="button-outer add-research-btn">
            <div class="button add-news">
                <a href="#" class="foot-link" data-toggle="modal" data-target="#CreateResearchModal">Submit Research</a>
            </div>
            <% include CreateResearchModal %>
        </div>
